...
import { getReviewsByAlbumIdController, postReviewController } from './reviews.controller';
 ...
 *               albumImage:
 *                 type: string
 *                 description: URL da capa do álbum (Opcional)
 *                 example: "https://exemplo.com/abbey-road.jpg"
 *               albumArtist:
 *                 type: string
 *                 example: "The Beatles"
 ...
 *         description: Erro interno do servidor.
 */
router.post('/reviews', authMiddleware, postReviewController);
